...
This project contains automated test cases for the Swift Translator system (https://www.swifttranslator.com/), which converts Singlish input to Sinhala output. The tests cover functional scenarios, UI behavior, and edge cases.
